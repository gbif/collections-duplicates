...
public class App {
  ...
  public static void main(String[] args) {
    ...
    if (cliArgs.getEntityType() == CliArgs.EntityType.ALL
        || cliArgs.getEntityType() == CliArgs.EntityType.INSTITUTIONS) {
      log.info("Inspecting institution duplicates");
      duplicatesInspector.inspectInstitutionDuplicates(request);
    }

    if (cliArgs.getEntityType() == CliArgs.EntityType.ALL
        || cliArgs.getEntityType() == CliArgs.EntityType.COLLECTIONS) {
